...
3. Listing détaillé des outils: chaque outil avec H3 numéroté "1. Nom - [accroche différenciante]".
...
RÈGLES: H3 numérotés - chiffres en chiffres - ✅/❌ en <p> jamais en <li> - ton "je" assumé - opinion tranchée par outil - tableau récap en bloc 2.
CHECK FINAL: recommandation dès l'intro ✓ tableau récap ✓ H3 numérotés ✓ ✅❌ en <p> ✓ 2 H2 informatifs ✓ conclusion par profil ✓`,
...
3. Listing détaillé des outils: H3 numéroté "1. Nom - [positionnement en quelques mots]".
   Structure identique par outil:
...
RÈGLES: vouvoiement systématique - chiffres en chiffres - ✅/❌ en <p> jamais en <li> - ancrage chiffré obligatoire - tableau récap en bloc 2 - structure de décision logique.
CHECK FINAL: recommandation dès l'intro ✓ tableau récap ✓ H3 numérotés ✓ ancrage chiffré ✓ 2 H2 informatifs ✓ conclusion par profil ✓`,
